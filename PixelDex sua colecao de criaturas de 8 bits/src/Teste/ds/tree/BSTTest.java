...
public class BSTTest {
    ...
    void setUp() {
        ...
        bst.insert(new Pixel(101, "Ariel", Raridade.COMUM, 10));
        bst.insert(new Pixel(202, "Bob", Raridade.RARO, 20));
        bst.insert(new Pixel(303, "Camilo", Raridade.LENDARIO, 30));
        bst.insert(new Pixel(404, "Bob", Raridade.EPICO, 25));
        bst.insert(new Pixel(505, "Ariel", Raridade.COMUM, 15));
    }
    @Test
